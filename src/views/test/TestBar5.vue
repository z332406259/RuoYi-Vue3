...
import {
  ...
  categoryLessXAxis,
  categoryXAxis,
  getTopBottomGradientColor,
  valueYAxis
} from '@/views/screen/ext/utils/echartsUtils'
import { useChartRef } from '@/views/screen/ext/hook/useChartRef'
import { computed } from 'vue'
import { testChart5Icon1, testChart5Icon2 } from '@/views/screen/ext/utils/imageBase64'
    ...
    series: [
      ...
      },
      {
        ...
        itemStyle: {
          ...
          color: getTopBottomGradientColor('#015EEA', '#00C0FA')
        }
      },
      {
        type: 'pictorialBar',
        symbolPosition: 'end',
        symbol: `image://${testChart5Icon2}`,
        symbolSize: [34, 21],
        symbolOffset: [0, -10],
        zlevel: 2
      }
