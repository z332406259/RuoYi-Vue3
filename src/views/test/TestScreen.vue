...
import * as THREE from '@/views/match/ext/assets/stage/three.mjs'
import { OrbitControls } from '@/views/match/ext/assets/stage/OrbitControls.js'
...
// renderer.setClearColor(0xdf0000, 1)
...
for (let i = 0; i < count1 + count2; i++) {
  ...
  if (i < count1) {
    ...
    const { x, y, z } = new THREE.Vector3().randomDirection().multiplyScalar(r)
